...
public class CandidateSync extends AsyncTask<String, Void, String> {
    ...
    public AsyncCandidateResponse delegate = null;
    ...
    public CandidateSync(Activity activity, String ExistingVote){
        ...
        CurrentUser = CurrentUser.getInstance(); //check!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        candidateList = new ArrayList<>();
        this.flag = flag;
        this.ExistingVote = ExistingVote;
        Url = "https://morning-anchorage-32230.herokuapp.com/scegetcandidatese";
    }
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            encryptedDataParams.put("VoteNum", VoteNum);
        ...
        if(!result.equals("")){
            try {
                ...
                for (int i = 0; i < UserVotings.length(); i++) {
                    ...
                    candidateList.add(new Candidate(c.getString("CandidateID"), c.getString("CandidateName")));
                }
